            ...
            <x-paper shadow="2">
                ...
                <div class="history-stats">
                    <div class="stats-grid">
                        <div class="stat-item">
                            ...
                            <span class="stat-label" data-i18n="total_transfers">Total Transfers</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-number" id="total-files">0</span>
                            <span class="stat-label" data-i18n="total_files">Files</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-number" id="total-data">0</span>
                            <span class="stat-label" data-i18n="total_data">Data</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-number" id="most-active-device">-</span>
                            <span class="stat-label" data-i18n="most_active_device">Most Active</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="history-filters">
                    <div class="filter-row">
                        <input type="text" id="history-search" placeholder="Search files, devices..." data-i18n-placeholder="search_placeholder">
                        <select id="filter-type">
                            <option value="" data-i18n="all_types">All Types</option>
                            <option value="file" data-i18n="files">Files</option>
                            <option value="text" data-i18n="texts">Texts</option>
                        </select>
                        <select id="filter-direction">
                            <option value="" data-i18n="all_directions">All</option>
                            <option value="sent" data-i18n="sent">Sent</option>
                            <option value="received" data-i18n="received">Received</option>
                        </select>
                    </div>
                    <div class="filter-row">
                        <select id="filter-file-type">
                            <option value="" data-i18n="all_file_types">All File Types</option>
                        ...
                        <button id="clear-filters" data-i18n="clear_filters">Clear</button>
                    </div>
                </div>
                ...
                <div class="history-list-container">
                    <div class="history-list-header">
                        <span class="sort-btn" data-sort="timestamp" data-i18n="time">Time</span>
                        <span class="sort-btn" data-sort="type" data-i18n="type">Type</span>
                        <span class="sort-btn" data-sort="direction" data-i18n="direction">Direction</span>
                        <span class="sort-btn" data-sort="fileName" data-i18n="name">Name</span>
                        <span class="sort-btn" data-sort="fileSize" data-i18n="size">Size</span>
                        <span class="sort-btn" data-sort="peerName" data-i18n="device">Device</span>
                    </div>
                ...
                <div class="history-actions">
                    <button id="export-history" data-i18n="export">Export</button>
                    <button id="clear-history" data-i18n="clear_history">Clear History</button>
        ...
        if (records.length === 0) {
            listContainer.innerHTML = `
                <div class="no-history">
                    <p data-i18n="no_history_found">No transfer history found</p>
                </div>
            `;
            return;
        }
