export default {
    ...
    // Device Modal
    "modal_select_devices": "Select Transfer Devices",
    "btn_cancel": "Cancel", 
    "btn_send_to_devices": "Send to Selected Devices",
    "btn_send_to_devices_count": "Send to",
    "devices": "devices",
    ...
    // File Converter
    "file_converter_title": "File Converter - DropShare",
    "file_converter_header": "🔄 File Converter",
    "back_to_home": "← Back to Home",
    "file_converter_subtitle": "Convert images, documents, audio, video and more formats",
    "upload_files_here": "Select or drag files here",
    "selected_files": "Selected files:",
    "convert_format": "Convert format:",
    "convert_progress": "Conversion progress:",
    "btn_start_convert": "Start Conversion",
    "btn_clear_files": "Clear Files",
    "convert_results": "Conversion results:",
    "supported_formats": "📋 Supported Conversion Formats",
    "image_formats": "🖼️ Image Formats",
    "document_formats": "📄 Document Formats",
    "audio_formats": "🎵 Audio Formats",
    "video_formats": "🎥 Video Formats",
    
    // Alert Messages
    "alert_enter_content": "Please enter content or select a file!",
    "alert_conversion_failed": "Conversion failed: ",
    "alert_no_result": "No conversion result to download!",
    "alert_enter_content_simple": "Please enter content!",
    "alert_enter_data": "Please enter data!",
    "alert_download_file": "Download ",
    "alert_demo_notice": "Note: This is a demo version, actual file conversion requires server support.",
    "confirm_transfer_redirect": "Transfer functionality requires returning to the transfer page.\n\nWould you like to go to the transfer page now?",
    
    // DOCX to HTML Converter
    "docx_to_html_title": "DOCX to HTML Converter - DropShare",
    "docx_to_html_header": "📝 DOCX to HTML Converter",
    "back_to_document_tools": "← Back to Document Tools",
    "docx_to_html_title_main": "Convert DOCX to HTML",
    "docx_to_html_subtitle": "Transform Microsoft Word documents into clean, web-ready HTML format",
    "upload_docx_files": "Select or drag DOCX files here",
    "supported_docx_formats": "Supports .docx, .doc files",
    "conversion_options": "Conversion Options:",
    "preserve_styles": "Preserve document styles",
    "include_images": "Include embedded images", 
    "clean_html": "Generate clean HTML",
    "responsive_layout": "Mobile-friendly layout",
    "converting": "Converting",
    "btn_new_conversion": "New Conversion",
    "features_title": "🚀 Features",
    "feature_preserve_formatting": "Preserve Formatting",
    "feature_preserve_formatting_desc": "Maintains original document styles and layout",
    "feature_image_support": "Image Support",
    "feature_image_support_desc": "Converts embedded images to web formats",
    "feature_responsive": "Responsive Design",
    "feature_responsive_desc": "Mobile-friendly HTML output",
    "feature_secure": "Secure Processing",
    "feature_secure_desc": "All processing happens locally",
    
    // DOCX to TXT Converter
    "docx_to_txt_title": "DOCX to TXT Converter - DropShare",
    "docx_to_txt_header": "📄 DOCX to TXT Converter",
    "docx_to_txt_title_main": "Convert DOCX to TXT",
    "docx_to_txt_subtitle": "Extract plain text content from Microsoft Word documents",
    "preserve_formatting_txt": "Preserve basic formatting",
    "include_line_breaks": "Preserve line breaks",
    "remove_extra_spaces": "Remove extra spaces",
    "add_metadata": "Include document metadata",
    ...
    "join_password_placeholder": "Enter room password",
    "confirm_join_room": "Join Room",
    "cancel_join_room": "Cancel",
    "copy_room_code": "Copy room code",
    "your_name_label": "Your Name:",
    "members_online": "members online",
    "room_members_label": "Room Members:",
    "leave_room_btn": "Leave Room",
    "upload_files_to_room": "📤 Upload Files to Room",
    "drag_files_here": "Drag files here or click to upload",
    "files_shared_to_all": "Files will be shared to all room members",
    "select_files_upload": "Select Files to Upload",
    "room_shared_files": "📁 Room Shared Files",
    "files_count": "files",
    "no_shared_files": "No shared files in room",
    "upload_hint": "After uploading, all room members can download",
    "file_uploader": "Uploader",
    "restored_tag": "Restored",
    "unavailable_hint": "Unavailable",
    "file_offline": "Offline",
    ...
    "transfer_copy_link": "Copy Link",
    "transfer_send_to": "Send to",
    "transfer_received_from": "Received from",
    ...
    "transfer_view_details": "View Details",
    "transfer_direction_sent": "Sent",
    "transfer_direction_received": "Received",
    "transfer_empty_search": "No matching transfer records found",
    "transfer_empty_filter": "No transfer records match the filter criteria",
    "transfer_back_to_home": "Back to Home",
    "transfer_unknown_device": "Unknown Device",
    "transfer_about_dropshare": "About DropShare",
    "transfer_easiest_way": "The easiest way to transfer files across devices",
    "transfer_github": "DropShare on Github",
    "transfer_cover_costs": "Help cover the server costs!",
    "transfer_tweet": "Tweet about DropShare",
    "transfer_faq": "Frequently asked questions",
    "transfer_modified_by": "Modified version by",
    "transfer_you_discovered": "You can be discovered by everyone on this network",
    "transfer_open_dropshare": "Open DropShare on other devices to send files",
    "transfer_click_to_send": "Click to send files or right-click to send messages",
    "transfer_tap_to_send": "Tap to send files or long-press to send messages",
    "transfer_file_received": "File Received",
    "transfer_filename": "Filename",
    "transfer_ask_save_files": "Ask to save each file before downloading",
    "transfer_save": "Save",
    "transfer_ignore": "Ignore",
    "transfer_send_message": "Send a Message",
    "transfer_send": "Send",
    "transfer_cancel": "Cancel",
    "transfer_message_received": "Message Received",
    "transfer_copy": "Copy",
    "transfer_close": "Close",
    "transfer_file_transfer_completed": "File Transfer Completed",
    "transfer_history": "Transfer History",
    "transfer_history_title": "History",
    "transfer_no_history": "No transfer history",
    "transfer_search_history": "Search history...",
    "transfer_filter_all": "All",
    "transfer_filter_sent": "Sent",
    "transfer_filter_received": "Received",
    "transfer_filter_files": "Files",
    "transfer_filter_messages": "Messages",
    "transfer_sort_by": "Sort by",
    "transfer_sort_time_desc": "Latest first",
    "transfer_sort_time_asc": "Oldest first",
    "transfer_sort_size_desc": "Largest first",
    "transfer_sort_size_asc": "Smallest first",
    "transfer_sort_name_asc": "Name A-Z",
    "transfer_sort_name_desc": "Name Z-A",
    "transfer_total_transfers": "Total Transfers",
    "transfer_total_size": "Total Size",
    "transfer_most_common_type": "Most Common Type",
    "transfer_export_history": "Export History",
    "transfer_clear_history": "Clear History",
    "transfer_confirm_clear": "Are you sure you want to clear all transfer history?",
    "transfer_export_json": "Export as JSON",
    "transfer_export_csv": "Export as CSV",
    "transfer_sent_to": "Sent to",
    "transfer_received_from": "Received from",
    "transfer_file_size_label": "Size",
    "transfer_time_label": "Time",
    ...
    "transfer_message_content": "Message Content",
    "transfer_history_stats_title": "Transfer Statistics",
    "transfer_total_files_sent": "Total Files Sent",
    "transfer_total_files_received": "Total Files Received",
    "transfer_total_messages_sent": "Total Messages Sent",
    "transfer_total_messages_received": "Total Messages Received",
    "transfer_average_file_size": "Average File Size",
    "transfer_largest_file": "Largest File",
    "transfer_most_active_device": "Most Active Device",
    "transfer_busiest_day": "Busiest Day",
    "transfer_trends": "Transfer Trends",
    "transfer_daily_activity": "Daily Activity",
    "transfer_weekly_summary": "Weekly Summary",
    "transfer_monthly_overview": "Monthly Overview",
    "transfer_search_placeholder": "Search transfer records...",
    "transfer_filter_by_type": "Filter by Type",
    "transfer_filter_by_direction": "Filter by Direction",
    "transfer_filter_by_file_type": "Filter by File Type",
    "transfer_filter_all_types": "All Types",
    "transfer_filter_all_directions": "All Directions",
    "transfer_filter_all_file_types": "All File Types",
    "transfer_filter_images": "Images",
    "transfer_filter_videos": "Videos",
    "transfer_filter_audio": "Audio",
    "transfer_filter_documents": "Documents",
    "transfer_filter_archives": "Archives",
    "transfer_filter_other": "Other",
    "transfer_clear_filters": "Clear Filters",
    "transfer_header_time": "Time",
    "transfer_header_type": "Type",
    "transfer_header_direction": "Direction",
    "transfer_header_name": "Name",
    "transfer_header_size": "Size",
    "transfer_header_device": "Device",
    "transfer_action_export": "Export",
    "transfer_action_delete": "Delete",
    "transfer_action_view_details": "View Details",
    "transfer_action_retry": "Retry",
    "transfer_direction_sent_label": "Sent",
    "transfer_direction_received_label": "Received",
    "transfer_empty_search_results": "No matching transfer records found",
    "transfer_empty_filter_results": "No transfer records match the filter criteria",
    "transfer_back_to_home_label": "Back to Home",
    "transfer_unknown_device_label": "Unknown Device",
    "transfer_about_snapdrop": "About DropShare",
    "transfer_easiest_way_label": "The easiest way to transfer files across devices",
    "transfer_github_label": "DropShare on Github",
    "transfer_cover_server_costs": "Help cover the server costs!",
    "transfer_twitter_label": "Tweet about DropShare",
} 