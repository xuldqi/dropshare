        ...
        dialog.innerHTML = `
            ...
            <x-paper shadow="2">
                ...
                <div class="room-options">
                    <button id="createRoomBtn" class="button primary" >Create Room</button>
                ...
                <div class="dialog-actions">
                    <button class="button"  onclick="this.parentNode.parentNode.parentNode.close()">Close</button>
                </div>
            </x-paper>
        `;
    ...
    createJoinRoomDialog() {
        ...
        dialog.innerHTML = `
            ...
            <x-paper shadow="2">
                ...
                <div class="dialog-actions">
                    <button class="button"  onclick="this.parentNode.parentNode.parentNode.close()">Cancel</button>
                    <button id="joinRoomConfirmBtn" class="button primary" >Join</button>
                </div>
            </x-paper>
        `;
        document.body.appendChild(dialog);
    ...
    createRoomMembersDialog() {
        ...
        dialog.innerHTML = `
            ...
            <x-paper shadow="2">
                ...
                <div class="dialog-actions">
                    <button id="leaveRoomBtn" class="button danger" >Leave Room</button>
                    <button id="roomSettingsBtn" class="button" >Settings</button>
                    <button class="button"  onclick="this.parentNode.parentNode.parentNode.close()">Close</button>
                </div>
            </x-paper>
        `;
    ...
    updateRecentRoomsList() {
        ...
        savedRooms.forEach(room => {
            ...
            roomElement.innerHTML = `
                ...
                <button class="rejoin-btn" data-room-code="${room.code}" >Rejoin</button>
            `;
