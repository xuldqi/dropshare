// About page script to handle page-specific translations
...
// Load translations for the about page
async function loadTranslations() {
    try {
        // Load the about page translations
        const translations = await loadPageTranslations('about', currentLang);
